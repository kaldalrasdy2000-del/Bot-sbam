...
# ============================================================
# إعدادات سيرفر الويب الوهمي (Flask) في الخلفية لإرضاء Render
# ============================================================
web_app = Flask('')
...
# ============================================================
def main():
    # تشغيل سيرفر الويب في Thread منفصل وخلفي تماماً
    flask_thread = threading.Thread(target=run_flask, daemon=True)
    flask_thread.start()

    # بناء وتشغيل البوت بالطريقة القياسية الصحيحة في الخيط الرئيسي
    ...
    print("[*] Telegram Bot and Flask Server are running successfully...")
    app.run_polling()
